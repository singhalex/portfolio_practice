import mainPortrait from "../assets/main_portrait.jpg";
    ...
    <div className="about__background">
      <div className="about__container">
        <div className="about__img_container">
          <img src={mainPortrait} alt="Main portrait" className="about__img" />
          <p className="about__name">Alex Singh</p>
        </div>
        <div>
          <div className="about__info_container">
            ...
            <p className="about__description">
              ...
              nulla quod qui laboriosam cumque doloremque ipsam nihil ab,
              aliquam non modi sed! Repellendus saepe suscipit rem quasi quidem
              atque? Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Eligendi rem reprehenderit in unde ducimus ipsam corrupti
              aspernatur corporis beatae, nemo laudantium exercitationem ut
              optio dolorum voluptas atque repellat, facere modi. lore
            </p>
            <div className="about__social_container">
              <a
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/alex-singh-748000254/"
                target="_blank"
                rel="noopener noreferrer"
              >
                {/* Linkedin logo */}
